...
class Register extends React.Component
{
    ...
    {
        fetch('https://sleepy-eyrie-76276.herokuapp.com/register', {
            method: 'post',
                    ...
                    <div className="measure center">
                        <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                            ...
                            <div className="mt3">
                                ...
                                <input onChange={this.onNameChange} className="br2 pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="text" name="name"  id="name"/>
                            </div>
                            <div className="mt3">
